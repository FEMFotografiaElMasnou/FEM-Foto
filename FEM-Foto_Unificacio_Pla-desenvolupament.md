...
**Proper pas immediat:** amb el Pas 4 tancat, queda per decidir, sense calendaritzar encara: el redisseny de les pantalles de resultat per al sistema d'1 sol concepte (§3.6 — «Resultat Repte» i la seva cortina de 3 criteris, encara amb el sistema antic), i el moment del tall per als reptes amb votació oberta.
