-- ROLLBACK del Pas 3b (NOMÉS projecte TEST). Recrea exactament les polítiques
-- que hi havia abans d'aplicar 2026-07-27_auth_migracio_pas3b_rls_test.sql,
-- capturades via `pg_policies` el 27/07/2026 abans de tocar res. Aplicar
-- aquest fitxer sencer si el Pas 3b falla algun test i cal desfer-ho de
-- seguida.

-- DROP de les polítiques noves
...
-- Recreació EXACTA de les polítiques originals (capturades via pg_policies)
CREATE POLICY "allow_anon_write" ON public.app_settings FOR ALL TO anon USING (true) WITH CHECK (true);
CREATE POLICY "allow_anon_read" ON public.app_settings FOR SELECT TO anon USING (true);
...
CREATE POLICY "allow_anon_write" ON public.objectives FOR ALL TO anon USING (true) WITH CHECK (true);
...
CREATE POLICY "allow_anon_read" ON public.objectives FOR SELECT TO anon USING (true);
CREATE POLICY "Permetre actualització de objectives" ON public.objectives FOR UPDATE TO public USING (true) WITH CHECK (true);

CREATE POLICY "allow_anon_write" ON public.photo_submissions FOR ALL TO anon USING (true) WITH CHECK (true);
...
CREATE POLICY "allow_anon_read" ON public.photo_submissions FOR SELECT TO anon USING (true);
...
CREATE POLICY "allow_insert" ON public.seguiment_votacio FOR INSERT TO public WITH CHECK (true);
CREATE POLICY "allow_select" ON public.seguiment_votacio FOR SELECT TO public USING (true);
CREATE POLICY "allow_update" ON public.seguiment_votacio FOR UPDATE TO public USING (true);
...
CREATE POLICY "allow_anon_write" ON public.users FOR ALL TO anon USING (true) WITH CHECK (true);
...
CREATE POLICY "allow_anon_read" ON public.users FOR SELECT TO anon USING (true);
CREATE POLICY "Permetre actualització de users" ON public.users FOR UPDATE TO public USING (true) WITH CHECK (true);

CREATE POLICY "allow_anon_write" ON public.votes FOR ALL TO anon USING (true) WITH CHECK (true);
...
CREATE POLICY "allow_anon_read" ON public.votes FOR SELECT TO anon USING (true);
