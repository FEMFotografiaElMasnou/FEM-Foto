...
export const TRANSLATIONS = {
  ca: {
    ...
    obj_status_tooltip: "Actiu = es mostra als socis ara mateix. Útil per decidir quin repte es veu quan n'hi ha més d'un amb dates que coincideixen.",
    objective_status_changed: 'Estat del repte actualitzat ✅',
    ...
    member_reset_error: '❌ No s\'ha pogut resetejar la contrasenya',
    // Contrasenya temporal (Reset fet per l'admin, 28/07/2026)
    temp_pwd_title: 'Contrasenya temporal',
    temp_pwd_msg: 'Aquesta és la contrasenya temporal de {name}. Fes-l\'hi arribar: amb la que tenia abans ja no pot entrar. Quan hagi entrat, pot canviar-la des de «Has oblidat la contrasenya?».',
    temp_pwd_warning: 'Aquesta contrasenya no es podrà tornar a consultar. Copia-la abans de tancar.',
    temp_pwd_copy: 'Copiar', temp_pwd_copied: '✓ Copiada',
    temp_pwd_copy_failed: 'No s\'ha pogut copiar. Selecciona-la a mà.',
    close_btn: 'Tancar',
    ...
    // Pas 4c — accés per correu (contrasenya oblidada + enllaç màgic)
    forgot_pwd_link: 'Has oblidat la contrasenya?',
    login_or: 'o bé',
    magic_link_btn: 'Entrar amb un enllaç per correu',
    reset_modal_title: 'Recuperar la contrasenya',
    reset_modal_msg: 'Escriu el teu email o el teu nom i t\'enviarem un correu amb un enllaç per crear una contrasenya nova.',
    magic_modal_title: 'Entrar amb un enllaç',
    magic_modal_msg: 'Escriu el teu email o el teu nom i t\'enviarem un correu amb un enllaç per entrar directament, sense contrasenya.',
    access_help_send: 'Envia\'m el correu',
    access_help_sending: 'Enviant...',
    access_help_fill: 'Escriu el teu email o el teu nom.',
    access_help_unknown: 'No consta cap compte amb aquestes dades. Comprova-ho o registra\'t.',
    access_help_sent: '📧 Correu enviat. Mira la teva safata d\'entrada (i el correu brossa).',
    access_help_rate_limit: 'S\'han enviat massa correus seguits. Espera uns minuts i torna-ho a provar.',
    access_help_error: 'No s\'ha pogut enviar el correu. Torna-ho a intentar.',
    link_expired: 'L\'enllaç del correu ha caducat o ja s\'ha fet servir. Demana\'n un de nou.',
    recovery_pwd_title: 'Crea la teva nova contrasenya',
    recovery_pwd_msg: 'Has entrat des de l\'enllaç del correu. Escriu la contrasenya nova que vulguis fer servir a partir d\'ara.',
    recovery_pwd_done: '✓ Contrasenya actualitzada',
    // Settings
    ...
    nav_valoracio: 'Valoració Repte',
    nav_valoracio_sub: 'Prova del nou sistema de puntuació (només admin)',
    nav_taula_classificacio: 'Taula de Classificació',
    nav_taula_classificacio_sub: 'Prova del nou sistema de puntuació (només admin)',
    nav_puntuacio: 'Puntuar Repte',
    nav_puntuacio_sub: 'Prova de captura del nou sistema (només admin)',
    puntuacio_screen_subtitle: 'Puntua cada foto de l\'1 al 10. No pots votar la teva pròpia foto.',
    ...
    // Commutador de sistema de puntuació (Fase 3, pestanya Puntuació de l'admin)
    puntuacio_nav_label: 'Puntuació',
    puntuacio_admin_title: 'Sistema de puntuació',
    puntuacio_admin_subtitle: 'Com voten els socis les fotos dels reptes',
    puntuacio_estat_label: 'Ara mateix els socis voten amb el sistema:',
    puntuacio_opcio_antic: 'Antic · 3 criteris',
    puntuacio_opcio_antic_desc: 'Creativitat, Temàtica i Composició, de 0 a 5 estrelles cadascun. La nota de la foto és la mitjana dels tres.',
    puntuacio_opcio_nou: 'Nou · 1 puntuació',
    puntuacio_opcio_nou_desc: 'Una sola puntuació de 0 a 10 per foto, tal com es va acordar a la reunió de socis.',
    puntuacio_actiu_marca: '✓ Actiu',
    puntuacio_admin_nota: 'El canvi és immediat per a tots els socis i es pot desfer en qualsevol moment tornant a prémer l\'altra opció. Cap vot ja emès s\'esborra ni es modifica: els dos sistemes es guarden alhora a cada vot.',
    puntuacio_avis_votacio: 'El repte «{repte}» té la votació oberta ara mateix. Pots canviar igualment: els vots ja fets es conserven i segueixen comptant. Però els socis que estiguin votant veuran canviar la pantalla de cop.',
    puntuacio_canviat_antic: 'Sistema antic (3 criteris) activat per a tots els socis',
    puntuacio_canviat_nou: 'Sistema nou (0-10) activat per a tots els socis',
    puntuacio_error: 'No s\'ha pogut canviar el sistema de puntuació',
    puntuacio_error_sessio: 'La teva sessió ja no és vàlida per fer aquest canvi. Prem «Sortir» i torna a entrar, i ja podràs canviar el sistema.',
    // Dashboard stats
    ...
    register_not_authorized: 'Accés restringit als socis de la FEM. Si creus que hi ha un error en aquest procés, contacta amb femfotografiaiapps@gmail.com',
    register_error: 'Error en crear el compte. Torna-ho a intentar.',
    generic_error: '❌ Error',
    session_expired: 'La sessió ha caducat. Torna a entrar.',
    ...
    untitled_photo: 'Imatge sense títol',
  ...
  es: {
    ...
    obj_status_tooltip: 'Activo = se muestra a los socios ahora mismo. Útil para decidir qué reto se ve cuando hay más de uno con fechas que coinciden.',
    objective_status_changed: 'Estado del reto actualizado ✅',
    ...
    member_reset_error: '❌ No se ha podido resetear la contraseña',
    // Contraseña temporal (Reset hecho por el admin, 28/07/2026)
    temp_pwd_title: 'Contraseña temporal',
    temp_pwd_msg: 'Esta es la contraseña temporal de {name}. Hazla llegar al socio: con la que tenía antes ya no puede entrar. Cuando haya entrado, puede cambiarla desde «¿Has olvidado la contraseña?».',
    temp_pwd_warning: 'Esta contraseña no se podrá volver a consultar. Cópiala antes de cerrar.',
    temp_pwd_copy: 'Copiar', temp_pwd_copied: '✓ Copiada',
    temp_pwd_copy_failed: 'No se ha podido copiar. Selecciónala a mano.',
    close_btn: 'Cerrar',
    ...
    yes_btn: 'Sí, resetear',
    // Pas 4c — acceso por correo (contraseña olvidada + enlace mágico)
    forgot_pwd_link: '¿Has olvidado la contraseña?',
    login_or: 'o bien',
    magic_link_btn: 'Entrar con un enlace por correo',
    reset_modal_title: 'Recuperar la contraseña',
    reset_modal_msg: 'Escribe tu email o tu nombre y te enviaremos un correo con un enlace para crear una contraseña nueva.',
    magic_modal_title: 'Entrar con un enlace',
    magic_modal_msg: 'Escribe tu email o tu nombre y te enviaremos un correo con un enlace para entrar directamente, sin contraseña.',
    access_help_send: 'Envíame el correo',
    access_help_sending: 'Enviando...',
    access_help_fill: 'Escribe tu email o tu nombre.',
    access_help_unknown: 'No consta ninguna cuenta con estos datos. Compruébalo o regístrate.',
    access_help_sent: '📧 Correo enviado. Mira tu bandeja de entrada (y el correo no deseado).',
    access_help_rate_limit: 'Se han enviado demasiados correos seguidos. Espera unos minutos e inténtalo de nuevo.',
    access_help_error: 'No se ha podido enviar el correo. Inténtalo de nuevo.',
    link_expired: 'El enlace del correo ha caducado o ya se ha usado. Pide uno nuevo.',
    recovery_pwd_title: 'Crea tu nueva contraseña',
    recovery_pwd_msg: 'Has entrado desde el enlace del correo. Escribe la contraseña nueva que quieras usar a partir de ahora.',
    recovery_pwd_done: '✓ Contraseña actualizada',
    // Settings
    ...
    nav_valoracio: 'Valoración Reto',
    nav_valoracio_sub: 'Prueba del nuevo sistema de puntuación (solo admin)',
    nav_taula_classificacio: 'Tabla de Clasificación',
    nav_taula_classificacio_sub: 'Prueba del nuevo sistema de puntuación (solo admin)',
    nav_puntuacio: 'Puntuar Reto',
    nav_puntuacio_sub: 'Prueba de captura del nuevo sistema (solo admin)',
    puntuacio_screen_subtitle: 'Puntúa cada foto del 1 al 10. No puedes votar tu propia foto.',
    ...
    // Conmutador de sistema de puntuación (Fase 3, pestaña Puntuación del admin)
    puntuacio_nav_label: 'Puntuación',
    puntuacio_admin_title: 'Sistema de puntuación',
    puntuacio_admin_subtitle: 'Cómo votan los socios las fotos de los retos',
    puntuacio_estat_label: 'Ahora mismo los socios votan con el sistema:',
    puntuacio_opcio_antic: 'Antiguo · 3 criterios',
    puntuacio_opcio_antic_desc: 'Creatividad, Temática y Composición, de 0 a 5 estrellas cada uno. La nota de la foto es la media de los tres.',
    puntuacio_opcio_nou: 'Nuevo · 1 puntuación',
    puntuacio_opcio_nou_desc: 'Una sola puntuación de 0 a 10 por foto, tal como se acordó en la reunión de socios.',
    puntuacio_actiu_marca: '✓ Activo',
    puntuacio_admin_nota: 'El cambio es inmediato para todos los socios y se puede deshacer en cualquier momento volviendo a pulsar la otra opción. Ningún voto ya emitido se borra ni se modifica: los dos sistemas se guardan a la vez en cada voto.',
    puntuacio_avis_votacio: 'El reto «{repte}» tiene la votación abierta ahora mismo. Puedes cambiar igualmente: los votos ya hechos se conservan y siguen contando. Pero los socios que estén votando verán cambiar la pantalla de golpe.',
    puntuacio_canviat_antic: 'Sistema antiguo (3 criterios) activado para todos los socios',
    puntuacio_canviat_nou: 'Sistema nuevo (0-10) activado para todos los socios',
    puntuacio_error: 'No se ha podido cambiar el sistema de puntuación',
    puntuacio_error_sessio: 'Tu sesión ya no es válida para hacer este cambio. Pulsa «Salir» y vuelve a entrar, y ya podrás cambiar el sistema.',
    // Dashboard stats
    ...
    register_not_authorized: 'Acceso restringido a los socios de la FEM. Si crees que hay un error en este proceso, contacta con femfotografiaiapps@gmail.com',
    ...
    untitled_photo: 'Imagen sin título',
